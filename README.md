...
An 8-shot black-and-white **Film Photo Booth** web app with your film-frame style.

## Behavior

- Photos are placed directly into 8 frame slots.
...
- **Undo Last Shot** removes only the latest shot (8th -> 7th -> 6th...).
